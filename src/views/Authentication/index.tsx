...
export default function Authentication() {
  ...
  const SignUpCard = () => {
    ...
    const onAgreedPersnalClickHandler = () => {
    ...
    const onAddressDetailKeyDownHandler = (
      ...
      if (!nicknameRef || !telNumberRef || !addressRef || !addressDetailRef)
        return;
              ...
              <>
                <div className="auth-consent-box">
                  <div
                    ...
                    onClick={onAgreedPersnalClickHandler}
                  >
                    <div
                      className={`icon ${
                        agreedPersonal
  ...
  return (
    <div id="auth-wrapper">
      <div className="auth-container">
        <div className="auth-jombotron-box">
          <div className="auth-jombotron-contents">
            <div className="auth-logo-icon"></div>
            <div className="auth-jombotron-text-box">
              <div className="auth-jombotron-text">{`환영합니다.`}</div>
              <div className="auth-jombotron-text">{`HOONS BOARD 입니다.`}</div>
            </div>
          </div>
        </div>
