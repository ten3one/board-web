...
export default function BoardDetail() {
  ...
  const increaseViewCountResponse = (
    reseponBody: IncreaseViewCountResponseDto | ResponseDto | null
  ) => {
    if (!reseponBody) return;
    const { code } = reseponBody;
        ...
        <div className="board-detail-top-header">
          ...
          <div className="board-detail-top-sub-box">
            <div className="board-detail-write-info-box">
              ...
              <div className="board-detail-info-divider">{`\ㅣ`}</div>
  ...
  const BoardDetailBottom = () => {
    ...
    const onFavoriteListClickHandler = () => {
      setShowFavorite(!showFavorite);
    };

    //          event handler: 댓글 상자 보기 클릭 이벤트 처리          //
    const onCommentListClickHandler = () => {
      setShowComment(!showComment);
    };

    //          event handler: 댓글 작성 버튼 클릭 이벤트 처리          //
    const onCommentSubmitButtonClickHandler = async () => {
    ...
    //          effect: 게시물 번호 path variable 바뀔 때 마다 좋아요, 댓글 리스트 불러오기          //
    useEffect(() => {
      if (!boardNumber) return;
      getFavoriteListRequest(boardNumber).then(getFavoriteListResponse);
      getCommentListRequest(boardNumber).then(getCommentListResponse);
      ...
      <div id="board-detail-bottom">
        <div className="board-detail-bottom-button-box">
          <div className="board-detail-bottom-button-group">
            ...
            <div className="icon-button" onClick={onFavoriteListClickHandler}>
              {showFavorite ? (
          ...
          <div className="board-detail-bottom-button-group">
            ...
            <div className="board-detail-bottom-button-text">
              {`댓글 `}
              <span className="emphasis">{totalComment}</span>
            </div>
            <div className="icon-button" onClick={onCommentListClickHandler}>
              {showComment ? (
                <div className="icon up-light-icon"></div>
              ) : (
                <div className="icon down-light-icon"></div>
  ...
  //          effect: 게시물 번호 path variable 바뀔 때 마다 게시물 조회 수 증가          //
